package top.howie.htron.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import top.howie.htron.framework.social.core.enums.AuthExtendSource;
import top.howie.htron.framework.social.core.request.AuthWeChatMiniAppRequest;
import top.howie.htron.framework.social.core.request.AuthWeChatMpRequest;
 ...
 * @date 2021-10-31
 */
public class HtronAuthRequestFactory extends AuthRequestFactory {
    ...
    public HtronAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
    ...
    protected AuthRequest getExtendRequest(String source) {
        // TODO Howie：临时兼容 justauth 迁移的类型不对问题；
