package top.howie.htron.framework.websocket.core;
...
public class HtronWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public HtronWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
