 ...
 */
@AutoConfiguration
// 允许使用 htron.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "htron.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class HtronWebSocketAutoConfiguration {
    @Bean
