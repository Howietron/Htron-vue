 ...
 *      1）Spring Async：
 *          {@link top.howie.htron.framework.quartz.config.HtronAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 HtronSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package top.howie.htron.framework.tenant;
