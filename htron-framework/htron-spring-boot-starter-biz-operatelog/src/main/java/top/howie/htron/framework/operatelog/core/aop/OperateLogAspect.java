package top.howie.htron.framework.operatelog.core.aop;
...
import top.howie.htron.framework.operatelog.core.service.OperateLog;
...
import static top.howie.htron.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        top.howie.htron.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                top.howie.htron.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         top.howie.htron.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           top.howie.htron.framework.operatelog.core.annotations.OperateLog operateLog,
