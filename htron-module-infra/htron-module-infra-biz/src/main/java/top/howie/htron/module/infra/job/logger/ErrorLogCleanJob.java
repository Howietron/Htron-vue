package top.howie.htron.module.infra.job.logger;

import top.howie.htron.framework.quartz.core.handler.JobHandler;
import top.howie.htron.framework.tenant.core.aop.TenantIgnore;
import top.howie.htron.module.infra.service.logger.ApiErrorLogService;
