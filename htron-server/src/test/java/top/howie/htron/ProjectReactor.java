...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "top.howie.boot";
    private static final String ARTIFACT_ID = "htron";
    private static final String PACKAGE_NAME = "top.howie.htron";
    private static final String TITLE = "htron后台管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "top.howie.boot";
        String artifactIdNew = "htron";
        String packageNameNew = "top.howie.htron";
        String titleNew = "htron后台管理系统";
