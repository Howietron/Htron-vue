...
import top.howie.htron.module.member.service.auth.MemberAuthServiceImpl;
...
// TODO @Howie：单测的 review，等逻辑都达成一致后
/**
 * {@link MemberUserServiceImpl} 的单元测试类
 *
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, HtronRedisAutoConfiguration.class})
