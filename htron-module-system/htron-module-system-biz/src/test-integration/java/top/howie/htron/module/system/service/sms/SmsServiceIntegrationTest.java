...
import top.howie.htron.framework.sms.config.HtronSmsAutoConfiguration;
import top.howie.htron.module.system.test.BaseDbAndRedisIntegrationTest;
...
// TODO @Howie：需要迁移
@Import({HtronSmsAutoConfiguration.class,
