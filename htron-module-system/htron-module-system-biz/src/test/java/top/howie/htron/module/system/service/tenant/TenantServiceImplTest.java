...
import top.howie.htron.framework.tenant.config.TenantProperties;
...
import top.howie.htron.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import top.howie.htron.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
...
import top.howie.htron.module.system.dal.mysql.tenant.TenantMapper;
import top.howie.htron.module.system.enums.permission.RoleCodeEnum;
import top.howie.htron.module.system.enums.permission.RoleTypeEnum;
import top.howie.htron.module.system.service.permission.MenuService;
import top.howie.htron.module.system.service.permission.PermissionService;
import top.howie.htron.module.system.service.permission.RoleService;
import top.howie.htron.module.system.service.tenant.handler.TenantInfoHandler;
import top.howie.htron.module.system.service.tenant.handler.TenantMenuHandler;
...
import static top.howie.htron.framework.common.util.collection.SetUtils.asSet;
...
import static top.howie.htron.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static top.howie.htron.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("htron", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("htron"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("htron");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
