...
import top.howie.htron.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
...
import top.howie.htron.module.system.dal.mysql.permission.MenuMapper;
import top.howie.htron.module.system.enums.permission.MenuTypeEnum;
...
import static top.howie.htron.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("Howie").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
