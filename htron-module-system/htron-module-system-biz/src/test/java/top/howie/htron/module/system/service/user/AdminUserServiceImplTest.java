package top.howie.htron.module.system.service.user;
...
import top.howie.htron.framework.common.util.collection.ArrayUtils;
...
import top.howie.htron.module.infra.api.file.FileApi;
...
import top.howie.htron.module.system.dal.mysql.dept.UserPostMapper;
import top.howie.htron.module.system.dal.mysql.user.AdminUserMapper;
import top.howie.htron.module.system.enums.common.SexEnum;
import top.howie.htron.module.system.service.dept.DeptService;
...
import top.howie.htron.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("htronyuanma");
        ...
        assertEquals("htronyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("htronyuanma"))).thenReturn("java");
