...
import top.howie.htron.framework.common.util.cache.CacheUtils;
...
public class SocialClientServiceImpl implements SocialClientService {
    ...
    @Resource // 由于自定义了 HtronAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private HtronAuthRequestFactory htronAuthRequestFactory;
    ...
    private AuthRequest buildAuthRequest(Integer socialType, Integer userType) {
        ...
        AuthRequest request = htronAuthRequestFactory.get(SocialTypeEnum.valueOfType(socialType).getSource());
