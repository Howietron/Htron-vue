package top.howie.htron.module.system.service.auth;
...
import top.howie.htron.framework.common.util.validation.ValidationUtils;
...
import top.howie.htron.module.system.controller.admin.auth.vo.*;
import top.howie.htron.module.system.convert.auth.AuthConvert;
...
public class AdminAuthServiceImpl implements AdminAuthService {
     ...
     * 验证码的开关，默认为 true
     */
    @Value("${htron.captcha.enable:true}")
