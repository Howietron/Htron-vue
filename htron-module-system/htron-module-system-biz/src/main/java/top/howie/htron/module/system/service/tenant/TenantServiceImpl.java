...
import top.howie.htron.framework.tenant.core.util.TenantUtils;
import top.howie.htron.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import top.howie.htron.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 htron.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
