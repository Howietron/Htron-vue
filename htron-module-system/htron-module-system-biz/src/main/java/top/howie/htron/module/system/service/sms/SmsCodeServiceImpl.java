...
import top.howie.htron.module.system.dal.mysql.sms.SmsCodeMapper;
import top.howie.htron.module.system.enums.sms.SmsSceneEnum;
import top.howie.htron.module.system.framework.sms.SmsCodeProperties;
...
import static top.howie.htron.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO Howie：提升，每个 IP 每天可发送数量
            // TODO Howie：提升，每个 IP 每小时可发送数量
        }
