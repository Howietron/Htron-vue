package top.howie.htron.module.system.controller.admin.socail.vo.client;
...
public class SocialClientBaseVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "htron商城")
