...
import top.howie.htron.framework.datapermission.core.util.DataPermissionUtils;
...
import top.howie.htron.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:htronyuanma}")
