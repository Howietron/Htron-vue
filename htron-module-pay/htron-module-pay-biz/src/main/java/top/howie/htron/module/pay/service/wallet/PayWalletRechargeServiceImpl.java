...
import top.howie.htron.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static top.howie.htron.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static top.howie.htron.module.pay.enums.ErrorCodeConstants.*;
import static top.howie.htron.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @Howie：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
    ...
    private PayWalletDO validateWalletRechargeCanRefund(PayWalletRechargeDO walletRecharge) {
        ...
        // TODO @Howie：需要考虑下，赠送的金额，会不会导致提现超过；
        return wallet;
    }
